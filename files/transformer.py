...
ss = SparkSession.builder.appName("transform").config("spark.sql.warehouse.dir", "/user/nagaraju/warehouse").config("hive.metastore.uris", "thrift://localhost:9083").enableHiveSupport().getOrCreate()                                                                                                  
